...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* Điều chỉnh khoảng cách cực kỳ sát cho câu thơ */
    .post-body { 
      font-size: 1.05rem; 
      line-height: 1.25; /* Thu nhỏ chiều cao dòng sát nhất có thể mà không đè chữ */
      color: #2c3e50; 
      margin-top: 1.2rem; 
    ...
    /* Thu hẹp khoảng cách dòng/đoạn về đúng tỉ lệ 0.6em */
    .post-body p {
      margin-bottom: 0.6em;
      line-height: 1.25;
    }
